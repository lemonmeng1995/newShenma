<template>
  <div id="manhome">
    <div class="manhome-box">
      ...
      <div class="manhome-context">
        ...
        <div class="context-bom">
          ...
          <p>智享版:
            {{new Date(smUserinfo.duTime).getFullYear() + '-' + (Number(new Date(smUserinfo.duTime).getMonth()) + 1) + '-' + new Date(smUserinfo.duTime).getDate()}}
          到期</p>
    ...
    <div class="man-cell">
      ...
      <van-cell title="基本信息" is-link  to="/freecreation?state=1"/>
